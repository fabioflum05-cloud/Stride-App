...
// ─── Icons ───────────────────────────────────────────────────
function IconUser() {
  return <Svg width={18} height={18} viewBox="0 0 24 24" fill="none"><Path d="M12 12C14.21 12 16 10.21 16 8C16 5.79 14.21 4 12 4C9.79 4 8 5.79 8 8C8 10.21 9.79 12 12 12ZM12 14C9.33 14 4 15.34 4 18V20H20V18C20 15.34 14.67 14 12 14Z" stroke={theme.blue} strokeWidth={1.5} strokeLinecap="round" /></Svg>;
}
function IconTrophy() {
  return <Svg width={18} height={18} viewBox="0 0 24 24" fill="none"><Path d="M6 9H4C3.45 9 3 8.55 3 8V4C3 3.45 3.45 3 4 3H20C20.55 3 21 3.45 21 4V8C21 8.55 20.55 9 20 9H18M6 9C6 9 6 17 12 17C18 17 18 9 18 9M6 9H18M12 17V21M8 21H16" stroke={theme.orange} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" /></Svg>;
}
function IconTarget() {
  return <Svg width={18} height={18} viewBox="0 0 24 24" fill="none"><Circle cx={12} cy={12} r={9} stroke={theme.purple} strokeWidth={1.5} /><Circle cx={12} cy={12} r={5} stroke={theme.purple} strokeWidth={1.5} /><Circle cx={12} cy={12} r={1.5} fill={theme.purple} /></Svg>;
}
function IconCalendar() {
  return <Svg width={18} height={18} viewBox="0 0 24 24" fill="none"><Path d="M8 2V5M16 2V5M3 8H21M5 4H19C20.1 4 21 4.9 21 6V20C21 21.1 20.1 22 19 22H5C3.9 22 3 21.1 3 20V6C3 4.9 3.9 4 5 4Z" stroke={theme.green} strokeWidth={1.5} strokeLinecap="round" /></Svg>;
}
function IconWatch() {
  return <Svg width={18} height={18} viewBox="0 0 24 24" fill="none"><Circle cx={12} cy={12} r={6} stroke={theme.teal} strokeWidth={1.5} /><Path d="M12 9V12L14 14M9 3H15L16 6H8L9 3ZM8 18L9 21H15L16 18H8Z" stroke={theme.teal} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" /></Svg>;
}
function IconHeart() {
  return <Svg width={18} height={18} viewBox="0 0 24 24" fill="none"><Path d="M12 21C12 21 3 14 3 8.5C3 6 5 4 7.5 4C9 4 10.5 4.8 12 6.5C13.5 4.8 15 4 16.5 4C19 4 21 6 21 8.5C21 14 12 21 12 21Z" stroke={theme.pink} strokeWidth={1.5} strokeLinecap="round" /></Svg>;
}
function IconUpload() {
  return <Svg width={18} height={18} viewBox="0 0 24 24" fill="none"><Path d="M21 15V19C21 20.1 20.1 21 19 21H5C3.9 21 3 20.1 3 19V15M17 8L12 3L7 8M12 3V15" stroke={theme.teal} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" /></Svg>;
}
function IconBell() {
  return <Svg width={18} height={18} viewBox="0 0 24 24" fill="none"><Path d="M18 8C18 6.4087 17.3679 4.88258 16.2426 3.75736C15.1174 2.63214 13.5913 2 12 2C10.4087 2 8.88258 2.63214 7.75736 3.75736C6.63214 4.88258 6 6.4087 6 8C6 15 3 17 3 17H21C21 17 18 15 18 8ZM13.73 21C13.5542 21.3031 13.3019 21.5547 12.9982 21.7295C12.6946 21.9044 12.3504 21.9965 12 21.9965C11.6496 21.9965 11.3054 21.9044 11.0018 21.7295C10.6981 21.5547 10.4458 21.3031 10.27 21" stroke={theme.orange} strokeWidth={1.5} strokeLinecap="round" /></Svg>;
}
function IconSun() {
  return <Svg width={18} height={18} viewBox="0 0 24 24" fill="none"><Circle cx={12} cy={12} r={4} stroke={theme.blue} strokeWidth={1.5} /><Path d="M12 2V4M12 20V22M4.22 4.22L5.64 5.64M18.36 18.36L19.78 19.78M2 12H4M20 12H22M4.22 19.78L5.64 18.36M18.36 5.64L19.78 4.22" stroke={theme.blue} strokeWidth={1.5} strokeLinecap="round" /></Svg>;
}
function IconGlobe() {
  return <Svg width={18} height={18} viewBox="0 0 24 24" fill="none"><Circle cx={12} cy={12} r={9} stroke={theme.green} strokeWidth={1.5} /><Path d="M12 3C12 3 9 7 9 12C9 17 12 21 12 21M12 3C12 3 15 7 15 12C15 17 12 21 12 21M3 12H21" stroke={theme.green} strokeWidth={1.5} strokeLinecap="round" /></Svg>;
}
function IconLock() {
...
function IconStar() {
  return <Svg width={18} height={18} viewBox="0 0 24 24" fill="none"><Path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" stroke={theme.orange} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" /></Svg>;
}
function IconDoc() {
  return <Svg width={18} height={18} viewBox="0 0 24 24" fill="none"><Path d="M14 2H6C5.46957 2 4.96086 2.21071 4.58579 2.58579C4.21071 2.96086 4 3.46957 4 4V20C4 20.5304 4.21071 21.0391 4.58579 21.4142C4.96086 21.7893 5.46957 22 6 22H18C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20V8L14 2ZM14 2V8H20M16 13H8M16 17H8M10 9H8" stroke={theme.textSecondary} strokeWidth={1.5} strokeLinecap="round" /></Svg>;
}
function IconLogout() {
  return <Svg width={18} height={18} viewBox="0 0 24 24" fill="none"><Path d="M9 21H5C4.46957 21 3.96086 20.7893 3.58579 20.4142C3.21071 20.0391 3 19.5304 3 19V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H9M16 17L21 12L16 7M21 12H9" stroke={theme.red} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" /></Svg>;
}
function IconChevron() {
  return <Svg width={16} height={16} viewBox="0 0 24 24" fill="none"><Path d="M9 18L15 12L9 6" stroke={theme.textTertiary} strokeWidth={1.5} strokeLinecap="round" /></Svg>;
}
...
export default function HomeScreen() {
  ...
  const focusText = score >= 70 ? '💪 Vollgas möglich'
    : score >= 50 ? '⚡ Moderat halten'
    : score > 0 ? '🌙 Erholung heute'
    : '🌱 Score ausfüllen';
