            ...
            <View style={styles.timeRow}>
              <View style={styles.timeGroup}>
                ...
                <View style={styles.timeInputs}>
                  ...
                  <TextInput style={styles.timeInput} value={bedMinute} onChangeText={setBedMinute} keyboardType="numeric" maxLength={2} />
                </View>
              </View>
              <View style={styles.timeGroup}>
                ...
                <View style={styles.timeInputs}>
                  ...
                  <Text style={styles.timeSep}>:</Text>
                  <TextInput style={styles.timeInput} value={wakeMinute} onChangeText={setWakeMinute} keyboardType="numeric" maxLength={2} />
                </View>
              </View>
            </View>
          </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.inputGrid}>
              <View style={styles.inputItem}>
                ...
                <TextInput style={styles.input} value={tiefsterPuls} onChangeText={setTiefsterPuls} keyboardType="numeric" placeholder="48" placeholderTextColor="#3D2E5C" />
              </View>
              <View style={styles.inputItem}>
                <Text style={styles.inputLabel}>Ø Puls</Text>
                <TextInput style={styles.input} value={avgPuls} onChangeText={setAvgPuls} keyboardType="numeric" placeholder="55" placeholderTextColor="#3D2E5C" />
              </View>
              <View style={styles.inputItem}>
                <Text style={styles.inputLabel}>HRV (ms)</Text>
                <TextInput style={styles.input} value={hrv} onChangeText={setHrv} keyboardType="numeric" placeholder="65" placeholderTextColor="#3D2E5C" />
              </View>
            </View>
          </View>

          <View style={styles.card}>
            <Text style={styles.cardTitle}>Schlafphasen (Stunden)</Text>
            <View style={styles.inputGrid}>
              <View style={styles.inputItem}>
                <Text style={styles.inputLabel}>Tiefschlaf</Text>
                <TextInput style={styles.input} value={deepZeit} onChangeText={setDeepZeit} keyboardType="decimal-pad" placeholder="1.5" placeholderTextColor="#3D2E5C" />
              </View>
              <View style={styles.inputItem}>
                <Text style={styles.inputLabel}>REM</Text>
                <TextInput style={styles.input} value={remZeit} onChangeText={setRemZeit} keyboardType="decimal-pad" placeholder="2.0" placeholderTextColor="#3D2E5C" />
              </View>
            </View>
          </View>

          <TouchableOpacity style={styles.saveBtn} onPress={save}>
            <Text style={styles.saveBtnText}>Schlaf speichern</Text>
          </TouchableOpacity>
        </>
      )}
    </ScrollView>
